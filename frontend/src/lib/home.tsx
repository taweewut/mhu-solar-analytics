...
export interface Caps {
  /**
   * Has 5-minute readings (Solis All-History): Health, TV, SOC heatmap, live "Today", and the
   * Day page's power curve. Without them Day shows the daily report instead.
   */
  fiveMin: boolean;
...
export function routeAvailable(route: Route, caps: Caps): boolean {
  if (route === "health" || route === "tv") return caps.fiveMin;
