 ...
 * shaded with the surface colour and an accent NOW line. All text is HTML overlaid on the SVG.
 */
export function DayLineChart(props: LineChartInput & { label: string }) {
  const { label, width, height, series, ymin, ymax, step, fmt, nowT } = props;
  const g = useMemo(
